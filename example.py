...
basically all similarity results reduce a lot, because according to Python information, the en_code_web_sm mode doesn't
have vector words so they use another similarity method that can and does affect the result. The moto en_core_web_md has
these vector words and therefore has a much more specific and accurate result in terms of similarity
